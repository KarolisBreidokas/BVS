...
namespace BVS.Migrations
{
    ...
    [Migration("20190519194641_FillDB")]
            ...
            modelBuilder.Entity("BVS.Data.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            ArivalDate = new DateTime(2019, 5, 27, 22, 46, 40, 618, DateTimeKind.Local).AddTicks(9181),
                            AuthorId = -2,
                            Date = new DateTime(2019, 5, 19, 22, 46, 40, 616, DateTimeKind.Local).AddTicks(7825)
                        });
                });
